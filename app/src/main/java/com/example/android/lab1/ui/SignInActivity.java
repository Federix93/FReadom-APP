...
//            {
//                Log.d("GNIPPO", "intent: "+getIntent());
//                Log.d("GNIPPO", "extras: "+getIntent().getExtras());
//                Log.d("GNIPPO", "ciao: "+getIntent().getExtras().getString("ciao"));
//                Intent intent = new Intent(SignInActivity.this, SearchBookActivity.class);
